...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init() {
      ...
      this.loading = true;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/').then(function () {
        _this.loading = false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_logo_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/logo.svg */ "./resources/js/assets/logo.svg");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])({
    ...
    logOut: function logOut() {
      ...
      this.logOutAction().then(function () {
        _this.$router.push({
          name: "login"
        });
      });
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])({
    ...
    onSubmit: function onSubmit() {
      ...
      if (!this.errors.length) {
        this.loading = true;
        this.getStudentDetails(this.examNo).then(function () {
          _this.loading = false;
          _this.success = true;
          _this.initiated = true;
        });
    ...
    onSubmit: function onSubmit() {
      ...
      if (!this.errors.length) {
        ...
        this.logIn(data).then(function () {
          ...
          _this.errors.push(error.response.data.error); // console.log("Your are fake");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])({
    ...
    validEmail: function validEmail(email) {
      var parttern = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
    ...
    onSubmit: function onSubmit() {
      ...
      if (!this.errors.length) {
        ...
        this.Register(data).then(function () {
          _this.loading = false; // this.$router.push({ name: "register" })
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("navbar", { staticClass: "mb-5", attrs: { app: this } }),
      _vm._v(" "),
      _vm.loading
        ? _c("spinner")
        : _vm.initiated
    ...
    _c(
      ...
      [
        ...
        _c(
          ...
          [
            _c("ul", { staticClass: "navbar-nav ml-auto mr-5 text-white" }, [
              _c(
                "li",
                { staticClass: "nav-item d-flex align-content-center" },
                [
                  _vm.authenticated
                    ? _c(
                        "div",
                        ...
                        [
                          _c("a", { staticClass: "nav-link text-white" }, [
                            _vm._v("Hi " + _vm._s(_vm.user.username))
                          ]),
                          _vm._v(" "),
                          _c(
                            "a",
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container col-md-6" }, [
    _c(
      "div",
      {
        staticClass: "col-md-8 mx-auto shadow-lg p-3 mb-5 bg-white rounded-lg"
      },
      [
        _vm._m(0),
        _vm._v(" "),
              ...
              [
                ...
                _c("div", { staticClass: "form-group" }, [
                  _c("input", {
                    ...
                    domProps: { value: _vm.examNo },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.examNo = $event.target.value
                      }
                    }
                  })
                ]),
            ...
            _vm.loading
              ...
              ? _c("div", [
                  _c("div", { staticClass: "mt-3 mb-2 " }, [
                    _c("div", { staticClass: " mb-1 mt-3" }, [
                      _c(
                        "h6",
                        { staticClass: "font-weight-bold mt-3 text-primary" },
                        [_vm._v("Candidates Details")]
                      )
                    ]),
                    _vm._v(" "),
                    _c("div", {}, [
                        ...
                        _c(
                          ...
                          [
                            _c("tr", [
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(_vm.studentDetails.surname))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("tr", [
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(_vm.studentDetails.first_name))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("tr", [
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(_vm.studentDetails.other_names))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("tr", [
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(_vm.studentDetails.exam_no))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("tr", [
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(_vm.studentDetails.serial))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("tr", [
                              ...
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(_vm.studentDetails.pin))])
                            ])
                          ]
                        )
                      ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: " mb-3" }, [
      _c("h6", { staticClass: "font-weight-bold mt-3 text-primary" }, [
        _vm._v("Enter Student Examination Number")
      ])
    ])
  }
]
    ...
    [
      _c("div", { staticClass: "container" }, [
        _c(
          ...
          {
            staticClass:
              "col-md-6 mx-auto shadow-lg p-3 mb-5 bg-white rounded-lg"
          },
          [
            _vm._m(0),
            _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "px-4 mb-n2" }, [
      _c("h4", { staticClass: "font-weight-bold mt-3 text-primary" }, [
        _vm._v("Login")
      ])
    ])
  }
  ...
  return _c("div", [
    _c("div", { staticClass: "container" }, [
      _c(
        "div",
        {
          staticClass: "col-md-6 mx-auto shadow-lg p-3 mb-5 bg-white rounded-lg"
        },
        [
          _vm._m(0),
          _vm._v(" "),
...
module.exports = "/images/logo.svg?50888e0666ed1f2582543510eb9d7589";
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getters: {
    ...
    studentDetails: function studentDetails(state) {
  ...
  mutations: {
    ...
    SET_STUDENT_DETAILS: function SET_STUDENT_DETAILS(state, data) {
  ...
  actions: {
    ...
    Register: function Register(_ref2, credentials) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("api/auth/register", credentials);
    },
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                commit("SET_USER", null); // console.log("failed");
    ...
    getStudentDetails: function getStudentDetails(_ref4, input) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                _context3.prev = 3;
                _context3.next = 6;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("api/auth/details?examNo=".concat(input)).then(function (response) {
...
__webpack_require__(/*! C:\xampp\htdocs\gpin\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\gpin\resources\sass\app.scss */"./resources/sass/app.scss");
